...
def help_message():
	print('Press F3 to print the accessible hierarchy for the focused window.\nPress F4 to exit.')

help_message()			            			            
pyatspi.Registry.registerKeystrokeListener(on_key_press,kind=(pyatspi.KEY_PRESSED_EVENT,pyatspi.KEY_RELEASED_EVENT))
